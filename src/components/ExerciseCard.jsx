...
export default function ExerciseCard(props) {
    ...
    return (
        <div className='p-4 rounded-md flex flex-col gap-4 bg-[#1F2937] sm:flex-wrap'>
            <div className='flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4'>
                ...
                <p className='text-sm text-slate-400 text-semibold capitalize'>{exercise.type}</p>
            </div>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2'>
                {['reps', 'rest', 'tempo'].map(info => {
                    return (
                        <div key={info} className='flex flex-col p-2 rounded border-[1.5px] border-solid border-[#C0C0C0] w-full'>
                ...
                <button onClick={handleSetIncrement} className='flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-[#C0C0C0] hover:border-blue-900 w-full duration-200'>
