...
export const EXERCISES = {
    ...
    hanging_knee_raises: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['abs'],
        description: 'Like the monkey you are, hang from the bar. Now raise your knees up, tuck your core, and hopefully you can touch your forehead to your knees. Release slowly down and try to reduce swinging momentum.',
    ...
    kneeling_cable_crunch: {
        ...
        unit: 'reps', //vs duration    
        muscles: ['abs'],
        description: 'On your knees, hold the cable rope extension behind your head with both hands (ensure it is at it\'s maximum height). Crunch your face down and kiss the ground, then slowly release back up.',
